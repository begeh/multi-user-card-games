...
// TO USE:
//
// Turn.dealer.deal() to deal a card!
...
class Turn {
  ...
  constructor(turnData) {
    const { player_1, player_2, p1_score, p2_score, p1_hand, p2_hand, dealer_hand, p1_play, p2_play, dealer_play } = turnData;
  ...
  resolveTurn() {
    ...
    return {
      ...
      dealer_hand: updateHand(this.dealer.hand, c),
      p1_hand: updateHand(this.player1.hand, a),
      p2_hand: updateHand(this.player2.hand, b),
